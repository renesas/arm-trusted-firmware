...
#define SYS_MSTACCCTL0				(SYS_BASE + 0x0000)
#define SYS_MSTACCCTL1				(SYS_BASE + 0x0004)
#define SYS_MSTACCCTL2				(SYS_BASE + 0x0008)
#define SYS_MSTACCCTL3				(SYS_BASE + 0x000C)
#define SYS_MSTACCCTL4				(SYS_BASE + 0x0010)
#define SYS_MSTACCCTL5				(SYS_BASE + 0x0014)
#define SYS_SLVACCCTL0				(SYS_BASE + 0x0100)
#define SYS_SLVACCCTL1				(SYS_BASE + 0x0104)
#define SYS_SLVACCCTL2				(SYS_BASE + 0x0108)
#define SYS_SLVACCCTL3				(SYS_BASE + 0x010C)
#define SYS_SLVACCCTL4				(SYS_BASE + 0x0110)
#define SYS_SLVACCCTL5				(SYS_BASE + 0x0114)
#define SYS_SLVACCCTL6				(SYS_BASE + 0x0118)
#define SYS_SLVACCCTL7				(SYS_BASE + 0x011C)
#define SYS_SLVACCCTL8				(SYS_BASE + 0x0120)
#define SYS_SLVACCCTL9				(SYS_BASE + 0x0124)
#define SYS_SLVACCCTL10				(SYS_BASE + 0x0128)
#define SYS_SLVACCCTL11				(SYS_BASE + 0x012C)
#define SYS_SLVACCCTL12				(SYS_BASE + 0x0130)
#define SYS_SLVACCCTL13				(SYS_BASE + 0x0134)
#define SYS_SLVACCCTL14				(SYS_BASE + 0x0138)
#define SYS_SLVACCCTL15				(SYS_BASE + 0x013C)
#define SYS_RAM0_ECC				(SYS_BASE + 0x0200)
#define SYS_RAM0_EN				(SYS_BASE + 0x0204)
#define SYS_RAM0_TEST				(SYS_BASE + 0x0208)
#define SYS_RAM0_MON				(SYS_BASE + 0x020C)
#define SYS_RAM1_ECC				(SYS_BASE + 0x0210)
#define SYS_RAM1_EN				(SYS_BASE + 0x0214)
#define SYS_RAM1_TEST				(SYS_BASE + 0x0218)
#define SYS_RAM1_MON				(SYS_BASE + 0x021C)
#define SYS_WDT0_CTRL				(SYS_BASE + 0x0220)
#define SYS_WDT1_CTRL				(SYS_BASE + 0x0230)
#define SYS_WDT2_CTRL				(SYS_BASE + 0x0240)
#define SYS_WDT3_CTRL				(SYS_BASE + 0x0250)
#define SYS_GPU_COHE				(SYS_BASE + 0x0300)
#define SYS_GPU_STRP				(SYS_BASE + 0x0304)
#define SYS_GPU_TEXT				(SYS_BASE + 0x0308)
#define SYS_H264_CFG0				(SYS_BASE + 0x0310)
#define SYS_H264_CFG1				(SYS_BASE + 0x0314)
#define SYS_H264_CFG2				(SYS_BASE + 0x0318)
#define SYS_H264_MON				(SYS_BASE + 0x031C)
#define SYS_H264_BSTOP				(SYS_BASE + 0x0320)
#define SYS_GETH0_CFG				(SYS_BASE + 0x0330)
#define SYS_GETH1_CFG				(SYS_BASE + 0x0340)
#define SYS_I2C0_CFG				(SYS_BASE + 0x0400)
#define SYS_I2C1_CFG				(SYS_BASE + 0x0410)
#define SYS_I2C2_CFG				(SYS_BASE + 0x0420)
#define SYS_I2C3_CFG				(SYS_BASE + 0x0430)
#define SYS_CANFD_CFG				(SYS_BASE + 0x0440)
#define SYS_SCIF0_CFG				(SYS_BASE + 0x0450)
#define SYS_SCIF1_CFG				(SYS_BASE + 0x0460)
#define SYS_SCIF2_CFG				(SYS_BASE + 0x0470)
#define SYS_SCIF3_CFG				(SYS_BASE + 0x0480)
#define SYS_SCIF4_CFG				(SYS_BASE + 0x0490)
#define SYS_SCI0_CFG				(SYS_BASE + 0x04A0)
#define SYS_SCI1_CFG				(SYS_BASE + 0x04B0)
#define SYS_CM33_STAT				(SYS_BASE + 0x0800)
#define SYS_CM33_CFG0				(SYS_BASE + 0x0804)
#define SYS_CM33_CFG1				(SYS_BASE + 0x0808)
#define SYS_CM33_CFG2				(SYS_BASE + 0x080C)
#define SYS_CM33_CFG3				(SYS_BASE + 0x0810)
#define SYS_CM33_LOCK				(SYS_BASE + 0x0814)
#define SYS_CM33_CTL				(SYS_BASE + 0x0818)
#define SYS_CA55_CFG_AArch0			(SYS_BASE + 0x0840)
#define SYS_CA55_CFG_AArch1			(SYS_BASE + 0x0844)
#define SYS_CA55_CFG_Endian0			(SYS_BASE + 0x0848)
#define SYS_CA55_CFG_Endian1			(SYS_BASE + 0x084C)
#define SYS_CA55_CFG_Thumb0			(SYS_BASE + 0x0850)
#define SYS_CA55_CFG_Thumb1			(SYS_BASE + 0x0854)
#define SYS_CA55_CFG_RVAL0			(SYS_BASE + 0x0858)
#define SYS_CA55_CFG_RVAH0			(SYS_BASE + 0x085C)
#define SYS_CA55_CFG_RVAL1			(SYS_BASE + 0x0860)
#define SYS_CA55_CFG_RVAH1			(SYS_BASE + 0x0864)
#define SYS_CA55_CFG_VA0			(SYS_BASE + 0x0868)
#define SYS_CA55_CFG_VA1			(SYS_BASE + 0x086C)
#define SYS_BBG_CTRL_ENABLE			(SYS_BASE + 0x0900)
#define SYS_BBG_CTRL				(SYS_BASE + 0x0904)
#define SYS_BBG_CTRL_MON			(SYS_BASE + 0x0908)
#define SYS_BBG_OFFSET0				(SYS_BASE + 0x090C)
#define SYS_BBG_OFFSET1				(SYS_BASE + 0x0910)
#define SYS_BBG_OFFSET2				(SYS_BASE + 0x0914)
#define SYS_BBG_OFFSET3				(SYS_BASE + 0x0918)
#define SYS_BBG_OFFSET4				(SYS_BASE + 0x091C)
#define SYS_BBG_OFFSET5				(SYS_BASE + 0x0920)
#define SYS_BBG_OFFSET6				(SYS_BASE + 0x0924)
#define SYS_BBG_OFFSET7				(SYS_BASE + 0x0928)
#define SYS_BBG_OFFSET_CTRL			(SYS_BASE + 0x0930)
#define SYS_BBG_PFREQ_MON			(SYS_BASE + 0x0934)
#define SYS_BBG_NFREQ_MON			(SYS_BASE + 0x0938)
#define SYS_BBG_TEMP_MON			(SYS_BASE + 0x093C)
#define SYS_BBG_VOLT_MON			(SYS_BASE + 0x0940)
#define SYS_LSI_MODE				(SYS_BASE + 0x0A00)
#define SYS_LSI_DEVID				(SYS_BASE + 0x0A04)
#define SYS_LSI_PRR				(SYS_BASE + 0x0A08)
#define SYS_LSI_OTPSECEN			(SYS_BASE + 0x0A0C)
#define SYS_LSI_OTPSECMODE			(SYS_BASE + 0x0A10)
#define SYS_LSI_OTPJAM				(SYS_BASE + 0x0A14)
#define SYS_LSI_OTPCORE				(SYS_BASE + 0x0A18)
#define SYS_LSI_OTPPOC				(SYS_BASE + 0x0A20)
#define SYS_JAUTH_JUDGE				(SYS_BASE + 0x0B00)
#define SYS_AOF0				(SYS_BASE + 0x0C00)
#define SYS_AOF1				(SYS_BASE + 0x0C04)
#define SYS_AOF2				(SYS_BASE + 0x0C08)
#define SYS_AOF3				(SYS_BASE + 0x0C0C)
#define SYS_AOF4				(SYS_BASE + 0x0C10)
#define SYS_AOF5				(SYS_BASE + 0x0C14)
#define SYS_AOF6				(SYS_BASE + 0x0C18)
#define SYS_AOF7				(SYS_BASE + 0x0C1C)
#define SYS_AOF8				(SYS_BASE + 0x0C20)
#define SYS_LP_CTL0				(SYS_BASE + 0x0D00)
#define SYS_LP_CTL1				(SYS_BASE + 0x0D04)
#define SYS_LP_CTL2				(SYS_BASE + 0x0D08)
#define SYS_LP_CTL3				(SYS_BASE + 0x0D0C)
#define SYS_LP_CTL4				(SYS_BASE + 0x0D10)
#define SYS_LP_CTL5				(SYS_BASE + 0x0D14)
#define SYS_LP_CTL6				(SYS_BASE + 0x0D18)
#define SYS_LP_CTL7				(SYS_BASE + 0x0D1C)
#define SYS_LP_CTL8				(SYS_BASE + 0x0D20)
#define SYS_LP_CM33CTL0				(SYS_BASE + 0x0D24)
#define SYS_LP_CM33CTL1				(SYS_BASE + 0x0D28)
#define SYS_LP_CM33CTL2				(SYS_BASE + 0x0D2C)
#define SYS_LP_CM33CPG				(SYS_BASE + 0x0D30)
#define SYS_LP_CA55_CTL0			(SYS_BASE + 0x0D34)
#define SYS_LP_CA55CK_CTL1			(SYS_BASE + 0x0D38)
#define SYS_LP_CA55CK_CTL2			(SYS_BASE + 0x0D3C)
#define SYS_LP_CA55CK_CTL3			(SYS_BASE + 0x0D40)
#define SYS_LP_CA55CPGC0			(SYS_BASE + 0x0D44)
#define SYS_LP_CA55CPGC1			(SYS_BASE + 0x0D48)
#define SYS_LP_GPU_CTL				(SYS_BASE + 0x0D50)
#define SYS_GPREG_0				(SYS_BASE + 0x0E00)
#define SYS_GPREG_1				(SYS_BASE + 0x0E04)
#define SYS_GPREG_2				(SYS_BASE + 0x0E08)
#define SYS_GPREG_3				(SYS_BASE + 0x0E0C)
#define SYS_RESREG_0				(SYS_BASE + 0x0E10)
#define SYS_RESREG_1				(SYS_BASE + 0x0E14)
#define SYS_RESREG_2				(SYS_BASE + 0x0E18)
#define SYS_RESREG_3				(SYS_BASE + 0x0E1C)
#define SYS_IPCONT				(SYS_BASE + 0x0E20)

#define SYS_LSI_MODE_STAT_MD_BOOT_POS		(0)
#define SYS_LSI_MODE_STAT_MD_BOOT		(7 << SYS_LSI_MODE_STAT_MD_BOOT_POS)
#define STAT_MD_BOOT_ESD			(0)
#define STAT_MD_BOOT_EMMC_1_8			(1)
#define STAT_MD_BOOT_EMMC_3_3			(2)
